import {
        ...
        <View style={[styles.child, { backgroundColor: 'white' }]}>
          <View style={{ width: '100%', backgroundColor: '#fff'}}>
            <ScrollView>
              <View>
                {
                  getMudhiyaNewsList && getMudhiyaNewsList.length > 0 ? getMudhiyaNewsList.map((element, index) => (
                    <>
  ...
  export default connect(mapStateToProps)(Madhuriya);