      ...
      <View style={[styles.child, { backgroundColor: 'white' }]}>
        <View style={{ width: '100%', backgroundColor: '#fff' }}>
          ...
          <ScrollView>
            ...
            {
                getNationalNewsList && getNationalNewsList.length > 0 ? getNationalNewsList.map((element, index) => (
                  <>
                  <>{index==0?<>
                    <TouchableOpacity onPress={() => navigation.navigate('NewsDetail', { id: element.id })}>
                      <View style={{  marginHorizontal: 15, marginVertical: 10, justifyContent: 'space-between',}}>
                        ...
                        <View>
                          <Image source={{ uri: element.imageLinkUrl }} style={{ height: 220, width: '100%', borderRadius: 10,alignSelf:'center',marginTop:10 }} />
                        </View>
                      </View>
