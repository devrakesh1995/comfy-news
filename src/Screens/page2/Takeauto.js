import {
        ...
        <View style={[styles.child, { backgroundColor: 'white' }]}>
          <View style={{ width: '100%', backgroundColor: '#fff',}}>
            <ScrollView>
              <View>
                {
                  getTakeautoNewsList && getTakeautoNewsList.length > 0 ? getTakeautoNewsList.map((element, index) => (
                    <>
  ...
  export default connect(mapStateToProps)(Takeauto);