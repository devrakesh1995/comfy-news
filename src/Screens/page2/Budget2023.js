import {
  ...
  const Budget2023 = props => {
    ...
    let { getBudget2023NewsList, } = users;
        ...
        <View style={[styles.child, { backgroundColor: 'white' }]}>
          <View style={{ width: '100%', backgroundColor: '#fff' }}>
            ...
            <ScrollView>
              ...
              {
                  getBudget2023NewsList && getBudget2023NewsList.length > 0 ? getBudget2023NewsList.map((element, index) => (
                    <>
                    <>{index==0?<>
  ...
  export default connect(mapStateToProps)(Budget2023);