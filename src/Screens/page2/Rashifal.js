import {
        ...
        <View style={[styles.child, { backgroundColor: 'white' }]}>
          <View style={{ width: '100%', backgroundColor: '#fff',  }}>
            <ScrollView>
              <View>
                {
                  getRashifalNewsList && getRashifalNewsList.length > 0 ? getRashifalNewsList.map((element, index) => (
                    <>
  ...
  export default connect(mapStateToProps)(Rashifal);